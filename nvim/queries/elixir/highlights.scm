; Bellow is the copied contents of the file in "stdpath('data')/lazy/nvim-treesitter/queries/elixir/highlights.scm"
; I don't know how to increment that file without copying and pasting it here.
; If that has an update, I guess I won't get the updated version.
; My own additions are at the end of the file.
; Search for --------------------- to find it.
...
; Apparently they have to be at the end, otherwise it gets overwritten by
; what comes after it, defeating the purpose of copy and pasting it here.

((call
   (identifier) @elixirPrivateDefine
