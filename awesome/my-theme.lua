...
theme.titlebar_bg_focus = ibgcolor
...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(taglist_square_size, textcolor)
theme.taglist_squares_unsel = theme_assets.taglist_squares_unsel(taglist_square_size, textcolor)
...
theme.my_yellow_notification_background = '#a18235'
