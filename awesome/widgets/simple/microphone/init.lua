...
-- }
-- local implementation = require('widgets.simple.microphone.pulseaudio')
local implementation = require('widgets.simple.microphone.wireplumber')
...
local function calculate_widget_output(out)
  local volume, is_muted = implementation.parse_output(out)
